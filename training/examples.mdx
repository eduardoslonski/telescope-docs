...
Mathematical reasoning using the [DAPO Math 17K](https://huggingface.co/datasets/BytedTsinghua-SIA/DAPO-Math-17k) dataset — a diverse collection of ~17K math problems. The model must solve problems and provide the final answer inside `\boxed{}`. Answers are verified symbolically using `math_verify`.
...
**Dataset**: [BytedTsinghua-SIA/DAPO-Math-17k](https://huggingface.co/datasets/BytedTsinghua-SIA/DAPO-Math-17k)
...
Mathematical reasoning for iterative context lengthening, using the [DeepScaleR](https://huggingface.co/datasets/agentica-org/DeepScaleR-Preview-Dataset) dataset. The model must solve problems and provide the final answer inside `\boxed{}`. Answers are verified symbolically using `math_verify`.
