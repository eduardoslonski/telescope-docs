...
| `reasoning_parser` | `str \| null` | `null` | Parser backend for thinking blocks |
| `enable_tool_call` | `bool` | `false` | Enable tool calling in inference |
| `tool_call_parser` | `str` | `"hermes"` | Tool call parser format |
...
| `wandb_project` | `str` | `"sketch-telescope"` | W&B project name |
