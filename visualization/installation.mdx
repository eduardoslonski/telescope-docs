...
Telescope automatically discovers runs tagged with `telescope` in your W&B projects. The default training config already includes this tag, so your runs will appear in the UI automatically.
